...
screen.connect_signal("arrange", function(s)
	...
	for _, c in pairs(s.clients) do
		if only_one and not c.floating or c.maximized then
			...
			c.border_width = 0 -- no borders in any case
		end
	end
end)
...
globalkeys = my_table.join(
	...
	end, { description = "increase horizontal tile size", group = "client" }),
	awful.key({ modkey, altkey }, "h", function()
		awful.tag.incmwfact(-0.01)
	end, { description = "decrese horizontal tile size", group = "client" }),
	awful.key({ modkey, altkey }, "j", function()
		awful.client.incwfact(0.01)
	end, { description = "decrese vertical tile size", group = "client" }),
	awful.key({ modkey, altkey }, "k", function()
		awful.client.incwfact(-0.01)
	end, { description = "inrease vertical tile size", group = "client" }),
	...
	-- Move clients (panes) in workspace
	...
	end, { description = "swap with client on the right", group = "client" }),
	awful.key({ modkey, "Shift" }, "h", function()
		awful.client.swap.bydirection("left")
	end, { description = "swap with client on the left", group = "client" }),

	-- Move clients (panes) between workspaces
